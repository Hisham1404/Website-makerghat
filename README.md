...
| Clean, maintainable, well-structured code            | Data-driven components, no magic numbers without a cited measurement, 344 tests                                              |
...
npm test       # 344 unit tests (Vitest)
...
344 tests, run with `npm test`. They are not coverage theatre — they pin the
