...
| Clean, maintainable, well-structured code            | Data-driven components, no magic numbers without a cited measurement, 352 tests                                              |
...
npm test       # 352 unit tests (Vitest)
...
352 tests, run with `npm test`. They are not coverage theatre — they pin the
